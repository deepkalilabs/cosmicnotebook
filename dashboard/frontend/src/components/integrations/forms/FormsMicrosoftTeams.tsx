...
export default function FormsMicrosoftTeams({onHandleCreateIntegration, handleCloseDialog}: IntegrationsButtonProps & {handleCloseDialog: () => void}) {
  ...
  const onSubmit = async (values: z.infer<typeof formSchema>) => {
    ...
    try {
      const res = await onHandleCreateIntegration('slack', values, userId, orgId);
