...
export default function FalForm({onHandleCreateConnector, handleCloseDialog}: ConnectorsButtonProps & {handleCloseDialog: () => void}) {
  ...
  const onSubmit = async (credentials: z.infer<typeof formSchema>) => {
    ...
    try {
      const res = await onHandleCreateConnector('fal', credentials);
  ...
  return (  
    <Form {...form}>
        <div>
            ...
            Connect with Fal in your notebook and run AI workflows.
            </p>
        </div>
        ...
        <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-6 mt-4">
          <FormField
            ...
            render={({ field }) => (
              <FormItem>
                <FormLabel>Fal API Key</FormLabel>
                <FormControl>
                ...
                <FormDescription>
                  ...
                  <br />
                  1. Go to the Fal Account Settings
                  <br />
                  2. Click on &quot;APIs&quot;
                  <br />
