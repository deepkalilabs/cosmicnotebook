...
export default function OpenRouterForm({onHandleCreateConnector, handleCloseDialog}: ConnectorsButtonProps & {handleCloseDialog: () => void}) {
  ...
  const onSubmit = async (credentials: z.infer<typeof formSchema>) => {
    ...
    try {
      const res = await onHandleCreateConnector('openrouter', credentials);
  ...
  return (  
    <Form {...form}>
        <div>
            ...
            Connect with OpenRouter in your notebook and run AI workflows.
            </p>
        </div>
            ...
            render={({ field }) => (
              <FormItem>
                ...
                <FormDescription>
                  ...
                  <br />
                  1. Go to the OpenRouter Account Settings
                  <br />
                  2. Click on &quot;APIs&quot;
                  <br />
