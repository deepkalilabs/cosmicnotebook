...
export default function FormsAnthropic({onHandleCreateConnector, handleCloseDialog}: ConnectorsButtonProps & {handleCloseDialog: () => void}) {
  ...
  const onSubmit = async (credentials: z.infer<typeof formSchema>) => {
    ...
    try {
      const res = await onHandleCreateConnector('claude', credentials);
      ...
      console.error("Error connecting to Anthropic", err);
      form.setError("root", { 
        message: "Failed to connect to Anthropic. Please check your credentials." 
      });
      setIsConnecting(false);
  ...
  return (  
    <Form {...form}>
        <div>
            ...
            Connect with Anthropic in your notebook and run AI workflows.
            </p>
        </div>
